...
class RegistrationWindow(tk.Toplevel):
    def __init__(self, master=None):
        ...
        # Reset Button
        tk.Button(self, text="Reset", command=self.reset_registration).grid(row=6, column=0)
    ...
    def validate_age(self, age):
        """
        Validates that an age is a valid integer and is 45 or above.
        """
        try:
            age_int = int(age)
            if age_int >= 45:
    ...
    def validate_registration(self):
        ...
        # Validate data types
        if not isinstance(name, str) or not isinstance(phone, str) or not isinstance(address, str) or not isinstance(age, str):
            return False
        ...
        # Defining Submit button for Registration
    def submit_registration(self):
        ...
        if not name or not email or not phone_number or not address or not age or not gender:
        ...
        if not self.validate_age(age):
            tk.messagebox.showerror("Error", "Please enter a valid age (45 or above).")
            return
        ...
        # Defining Reset Button for Resgistration
...
class VitalsWindow(tk.Toplevel):
    def __init__(self, name, email, phone_number, address, age, gender):
        ...
        # Exit Button
        tk.Button(self, text="Exit", command=self.destroy).grid(row=7, column=0)

        # Defining Submit Button for Vitals
    def submit_vitals(self):
        ...
        try:
            ...
            tk.messagebox.showerror("Error", "Please enter valid values for vitals.")
            return
